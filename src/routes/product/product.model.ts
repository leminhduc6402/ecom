...
export const GetProductsQuerySchema = z.object({
  ...
  orderBy: z.enum([OrderBy.ASC, OrderBy.DESC]).optional().default(OrderBy.DESC),
  sortBy: z.enum([SortBy.Price, SortBy.CreatedAt, SortBy.Sale]).optional().default(SortBy.CreatedAt),
});
